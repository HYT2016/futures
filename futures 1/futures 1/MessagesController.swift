...
//        let cell = UITableViewCell(style: .subtitle, reuseIdentifier: "cellId")
    ...
    func handleNewMessage(){
        ...
        newMessageController.messengerController=self
...
//            for some reason uid is nil
        ...
        Database.database().reference().child("users").child(uid).observeSingleEvent(of: .value, with: { (snapshot) in
            ...
            if let dictionary = snapshot.value as? [String: AnyObject]{
                ...
                self.setUpNavBarWitUser(user: user)
            }
    ...
    func setUpNavBarWitUser(user:Users){
        messages.removeAll()
...
//        titleView.backgroundColor = UIColor.red
        ...
        if let profileImageUrl=user.profileImageUrl{
            profileImageView.loadImageUsingCatcheWithUrlString(urlString: profileImageUrl)
        }
